...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="/" class="logo">
            ...
            <span class="logo-mini"><b>SMS</b>i</span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg"><b>SMSinfo SYSTEM</b></span>
        </a>
            ...
            \yiister\adminlte\widgets\Menu::widget(
                [
                    "items" => [
                        ...
                        ["label" =>Yii::t('app','SMS'), "url" =>  ["/sms-log/index"], "icon" => "fa fa-envelope",],
                        ["label" =>Yii::t('app','SMS Template'), "url" =>  ["/sms-template/index"], "icon" => "fa fa-file",],
                        ["label" =>Yii::t('app','Clients'), "url" =>  ["/client/index"], "icon" => "fa fa-user",],
                         ["label" =>Yii::t('app','Groups'), "url" =>  ["/group/index"], "icon" => "fa fa-folder",],
    ...
    <footer class="main-footer">
        ...
        <!-- Default to the left -->
        <strong>Copyright &copy; SMSinfo <?= date("Y") ?></strong>
    </footer>
...
<script>
   ...
   var radios = document.getElementsByName("SmsLog[send_to]");
        ...
        for(var i = 0; i < radios.length; i++){
            if(radios[i].checked){
                ...
                //alert(val);
                if(val==1){
        var to=document.getElementById("smslog-to").value;
        var sms=document.getElementById("smslog-content").value;
        ...
        xhr.send(data);
        theUrl = 'http://localhost/sms/index.php?r=sms-log/create-log&to=' + to + '&sms=' + sms;
        ...
        var to=document.getElementById("smslog-to").value;
         ...
         $.get("<?php echo Yii::$app->urlManager->createUrl(['group-contact/filter-client','id'=>'']);?>"+to,function(data) {
                        //alert(data);
                         var num = data.split('-');
                         //alert(num.length);
    ...
    for(var i = 1; i < num.length; i++){   
     ...
     $("#smslog-send_to").change(function(){
        var radios = document.getElementsByName("SmsLog[send_to]");
        //alert(radios);
        var val;
        for(var i = 0; i < radios.length; i++){
            if(radios[i].checked){
                ...
                if(val==1){
                    ...
                    $.get("<?php echo Yii::$app->urlManager->createUrl(['client/filter-client']);?>",function(data) {
                        //alert(data);
                  $("#smslog-to").html(data);
                    });
                }else if(val==2){

                    $.get("<?php echo Yii::$app->urlManager->createUrl(['group/filter-group']);?>",function(data) {
