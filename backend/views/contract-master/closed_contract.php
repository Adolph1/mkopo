...
<div class="contract-master-view">
 ...
 <div class="col-md-12">
     ...
     <div style="margin-bottom: 5px"><?php // Html::a('Liquidate', ['payment','id' => $model->contract_ref_no], ['class' => 'btn btn-warning']) ?></div>
     <div style="margin-bottom: 5px"><?php // Html::a('Liquidate', ['normalpayment','id' => $model->contract_ref_no], ['class' => 'btn btn-warning']) ?></div>
