...
<div class="row">
    ...
    <legend class="scheduler-border text-info">Personal Details</legend>
        ...
        <div class="row">
            <div class="col-md-12">
                <?= $form->field($model, 'date_of_birth')->textInput(['readonly'=>'readonly']) ?>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <?= $form->field($model, 'gender')->textInput(['readonly'=>'readonly']) ?>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <?= $form->field($model, 'marital_status')->textInput(['readonly'=>'readonly']) ?>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
