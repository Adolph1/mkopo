...
/**
 * This is the model class for table "tbl_history_entry".
 *
 * @property integer $id
...
class HistoryEntry extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['module', 'trn_ref_no', 'trn_dt', 'entry_sr_no', 'ac_no', 'ac_branch', 'event_sr_no', 'event', 'amount', 'amount_tag', 'drcr_ind', 'trn_code', 'related_customer', 'batch_no', 'product', 'value_dt', 'finacial_year', 'period_code', 'maker_id', 'maker_stamptime', 'checker_id', 'auth_stat', 'delete_stat', 'instrument_code'], 'required'],
            [['amount'], 'number'],
            [['module', 'trn_ref_no', 'trn_dt', 'entry_sr_no', 'ac_no', 'ac_branch', 'event_sr_no', 'event', 'amount_tag', 'drcr_ind', 'trn_code', 'related_customer', 'batch_no', 'product', 'value_dt', 'finacial_year', 'period_code', 'maker_id', 'maker_stamptime', 'checker_id', 'auth_stat', 'delete_stat', 'instrument_code'], 'string', 'max' => 200]
        ];
    }
