...
<div class="customer-form">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <?= $form->field($model, 'gender')->dropDownList(['F' => 'Female','M'=>'Male'],['prompt'=>Yii::t('app','--Select--')]) ?>
        </div>
        <div class="col-md-4">
            <?= $form->field($model, 'marital_status')->dropDownList(['Single' => 'Single','Married'=>'Married','Divorced'=>'Divorced'],['prompt'=>Yii::t('app','--Select--')]) ?>
        </div>
    </div>
    <div class="row">
        <div class="col-md-4">
    ...
    <?= $form->field($model, 'customer_type_id')->dropDownList(\backend\models\CustomerType::getAll(),['prompt'=>Yii::t('app','--Select--')]) ?>
        ...
        <div class="col-md-3">
            <?= $form->field($model, 'group_id')->dropDownList(\backend\models\Group::getAll(),['prompt'=>Yii::t('app','--Select--')]) ?>
        </div>
        <div class="col-md-3">
